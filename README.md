...
1гигабит/в сек и сетью способной принять входящий трафик - 200Мбит/сек
...
2. Несколько лет открытый баг в тарантуле про проблемы [pub/sub](https://github.com/tarantool/tarantool/issues/946).
Наличие этого бага заставляет расходовать примерно по 1 гигабайту RAM на каждых
